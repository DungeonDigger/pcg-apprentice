...
public class ApprenticeshipLearning2 {
	...
	public static Policy getLearnedPolicy(ApprenticeshipLearningRequest request) {
		...
		if (request.getUsingMaxMargin()) {
			return ApprenticeshipLearning2.maxMarginMethod(request);
		}
		return ApprenticeshipLearning2.projectionMethod(request);
	}
	...
	private static Policy maxMarginMethod(ApprenticeshipLearningRequest request) {
		...
		for (int i = 0; i < maxIterations; ++i) {
			...
			RewardFunction rewardFunction =
					ApprenticeshipLearning2.generateRewardFunction(featureFunctions, featureWeights);
	 ...
	 * @return the policy that mimics the expert
	 */
	public static RewardFunction projectionMethodReward(ApprenticeshipLearningRequest request) {
