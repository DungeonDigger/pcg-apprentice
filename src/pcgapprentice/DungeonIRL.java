...
public class DungeonIRL {
	...
	public static void main(String[] args) {
		try {
			...
			Episode ep = trainIrlAgentAndGenerateEpisode(demoFiles, 5, 3,
					400, 0.005, 5);
	...
	private static Episode trainIrlAgentAndGenerateEpisode(String[] expertDemonstrationFiles, double endReward,
														   ...
														   double rolloutRefreshProbIncr, int rolloutMaxRefreshes) throws IOException {
		...
		Episode agentEp = DungeonPolicyUtils.rolloutWithRefreshProbability(policy,
				startStateGenerator.generateState(), domain.getModel(), rolloutMaxSteps, rolloutRefreshProbIncr,
				rolloutMaxRefreshes);
